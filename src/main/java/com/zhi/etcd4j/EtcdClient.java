...
public class EtcdClient {
     ...
     */
    public EtcdClient(String uri, int port) {
        StringUtil.assertEmpty(uri, "Instantiate EtcdClient error, uri [" + uri + "]");
    ...
    /**
     * Check EtcdClient's available, that's to say make sure EtcdClient can access the given uri.
     */
    private void checkAvailable() {
        ...
        try {
            ...
            //EtcdClient is available.
            return;
        } catch (EtcdException e) {
            //EtcdClient is not available.
            throw e;
        }
    }
    ...
    private EtcdResult syncExecute(Request request) throws EtcdException {
        ...
        try {
            ...
            throw new EtcdException("Execute http request error, please check network connection.", e);
        }
        String bodyStr;
        try {
